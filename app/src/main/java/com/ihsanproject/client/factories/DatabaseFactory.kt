package com.ihsanproject.client.factories

import android.content.Context
import androidx.room.*
import com.ihsanproject.client.domain.models.*
import com.ihsanproject.client.repositoryInstances.BooksDao
import com.ihsanproject.client.repositoryInstances.SettingsDao
import com.ihsanproject.client.repositoryInstances.UserDao
                ...
                synchronized(DatabaseFactory::class.java) {
                    if (INSTANCE == null) {
                        INSTANCE = Room.databaseBuilder(
                            ...
                            DatabaseFactory::class.java, "ihsan.db"
                        )
                            .build()
                    }
                }
